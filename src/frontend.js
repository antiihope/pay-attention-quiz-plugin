    ...
    >
      ...
      <ul>
        {props.answers.map((answer, index) => {
          let classNames = isCorrectDelayed === true && index === props.correctAnswer ? ' no-click ' : '';
          classNames += isCorrectDelayed == true && index !== props.correctAnswer ? ' fade-incorrect ' : '';

          return (
            <li className={classNames} onClick={isCorrect === true ? undefined : () => handeAnswer(index)}>
      ...
      <div className={'correct-message ' + (isCorrect === true ? 'correct-message--visible' : '')}>
        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" className="bi bi-emoji-smile" viewBox="0 0 16 16">
      ...
      <div className={'incorrect-message ' + (isCorrect === false ? 'correct-message--visible' : '')}>
        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" className="bi bi-emoji-frown" viewBox="0 0 16 16">
          <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
